json.array!(@appointments) do |appointment|
  ...
  json.tooltip appointment.external_participant_salutation + " " + appointment.external_participant_title + " " + appointment.external_participant_name + ", bei " + appointment.clear_group_employee_vocalized_salutation + " " + appointment.clear_group_employee_name
